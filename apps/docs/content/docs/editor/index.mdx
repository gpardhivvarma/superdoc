...
| SvelteKit                               | [SvelteKit guide](/editor/frameworks/sveltekit)  | Browser mount timing, cleanup, and export               |
...
After mounting the Editor, decide who owns the controls around the document. [Who renders the UI?](/editor/who-renders-the-ui) compares the built-in UI, a configured built-in UI, and application-owned controls.
...
- [Choose the built-in UI or custom controls](/editor/who-renders-the-ui).
- [Understand how SuperDoc preserves DOCX meaning](/resources/how-superdoc-works).
