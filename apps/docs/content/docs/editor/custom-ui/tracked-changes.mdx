...
If SuperDoc should render the review surfaces instead, see [tracked changes](/editor/track-changes).
...
For the standard interface, use [Review tracked changes](/editor/track-changes). For the operation contract, use [Document API tracked changes](/document-api/tracked-changes).
