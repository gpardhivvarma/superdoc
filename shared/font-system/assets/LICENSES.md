...
**Comic Relief** - OFL-1.1

```text
Copyright 2013 The Comic Relief Project Authors (https://github.com/loudifier/Comic-Relief)
License description: This Font Software is licensed under the SIL Open Font License, Version 1.1.
```
...
names, including the Carlito and PT Sans Reserved Font Names. For Caladea, the
same statement satisfies the Apache-2.0 section 4(b) "modified files" notice.
